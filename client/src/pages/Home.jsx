function Home() {
    return (
      <section class="flex justify-center">
          ...
          <div class="flex justify-center mt-7 w-full bg-stone-50 rounded-lg border-4 border-violet-600 shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
